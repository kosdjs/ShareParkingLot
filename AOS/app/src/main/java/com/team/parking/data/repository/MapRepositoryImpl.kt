...
class MapRepositoryImpl(
    ...
    override suspend fun getParkingLotDetail(lotId: Int): Resource<MapDetailResponse> {
        return responseToMapDetailResource(mapRemoteDatasource.getParkingLotDetail(lotId))
    }
